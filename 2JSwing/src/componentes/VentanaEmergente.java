...
public class VentanaEmergente {
    ...
    public VentanaEmergente(){
        ...
        ventanaEmergente.setTitle("Java Swing2");   //Para a?adir un titulo a la ventana
        ventanaEmergente.setBounds(200, 200, 300, 300);    //Para elegir el tama?o de la ventana
        ventanaEmergente.setResizable(false);   //Para permitir (o no) que se cambie el tama?o de ventana
